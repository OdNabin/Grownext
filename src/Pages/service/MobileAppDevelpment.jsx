...
const MobileAppDevelpment = () => {
  const navigate = useNavigate()
  return (
   <div className='overflow'>
     <div className="container-fluid mb-2">
         <h6 className='text-center mb-2  common' style={{color:"#075DF0",fontSize:"18px"}}><p style={{color:"blue",cursor:"pointer"}} onClick={()=>navigate("/service")}>Service</p><p className='ps-2 pe-2'>/</p><p >Mobile App Development</p></h6>
         <h1 className='text-center heading'>Mobile App Development</h1>
...
export default MobileAppDevelpment