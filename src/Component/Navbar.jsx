  ...
  <div className="container  Navbar align-items-center   my-3" style={{borderRadius:"30px",padding:"10px",backgroundColor:"#EAEAE8"}}>
    ...
    <div className="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      <div className="offcanvas-header">
        <h5 className="offcanvas-title" id="offcanvasNavbarLabel"><img src="./icons/Home/logo.png" alt="logo" srcset="" className='logo' /></h5>
...
<li className='nav-item'  data-bs-dismiss="offcanvas" aria-label="Close">
        ...
        <ul className="navbar-nav justify-content-end flex-grow-1 pe-1"  data-bs-dismiss="offcanvas" aria-label="Close">
